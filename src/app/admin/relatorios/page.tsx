    ...
    const fetchDadosRelatorio = async () => {
      ...
      setTimeout(() => {
        ...
        const dadosSimulados: ResumoRelatorio = {
          faturamentoTotal: 45678.9,
          faturamentoMensal: [
            3200, 3450, 3800, 4100, 3900, 4300, 4600, 4800, 5100, 4900, 5200,
            5700,
          ],
          clientesNovos: 75,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-3xl font-bold text-green-600">
              {formatarValor(dados.faturamentoTotal)}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-sm text-gray-600">
              Clientes que voltaram no período
            </p>
          </div>
        </div>
                ...
                <div key={index}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm text-gray-600">
                      {servico.quantidade} ({servico.percentual}%)
                    </span>
                  </div>
              ...
              {dados.horariosPopulares.map((horario, index) => (
                <div key={index}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm text-gray-600">
                      {horario.quantidade} ({horario.percentual}%)
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
              ...
              {dados.produtosMaisVendidos.map((produto, index) => (
                <div key={index}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm text-gray-600">
                      {produto.quantidade} unid. ({produto.percentual}%)
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
